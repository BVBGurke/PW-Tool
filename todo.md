# Umstrukturierung: Backend, Frontend und Website

- [x] Vollständigen Architekturfragebogen auswerten und bestätigten Arbeitsbrief festhalten.
- [x] LAN-Bindung, Kontenmodell, Datenbankgrenzen und Verschlüsselungsmodell verbindlich dokumentieren.
- [x] Zielstruktur für Python-Backend, React-Frontend, getrennte Website und gemeinsame Schnittstellen definieren.
- [x] Plattformstartdateien für Windows, Unix/macOS/Linux und Android/Termux spezifizieren.
- [x] Python-Backend in die neue Struktur überführen und die abgelöste Textual-CLI entfernen.
- [x] React-Frontend mit festgelegtem Betriebsmodell und Datenschutzgrenzen implementieren.
